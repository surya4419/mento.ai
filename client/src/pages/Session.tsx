              ...
              {showChat && (
                ...
                >
                  <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                    <h3 className="font-semibold text-gray-900 dark:text-white">Chat with ZEO-EDU</h3>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-start">
                        <div className="max-w-xs bg-zeo-primary/90 text-white p-3 rounded-2xl rounded-tl-none shadow-sm">
                          <p className="text-sm">Hello! I'm ZEO-EDU, your AI teacher. What would you like to learn today?</p>
